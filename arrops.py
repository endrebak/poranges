...
def overlap_intervals(starts1, ends1, starts2, ends2, closed=False, sort=False):
    ...
    # print("match_2in1_mask", match_2in1_mask)
    # print("match_1in2_mask", match_1in2_mask)
    ...
    # print(ids1[match_2in1_mask])
    # print(match_2in1_ends - match_2in1_starts)

    # print(ids2[match_1in2_mask])
    # print(match_1in2_ends - match_1in2_starts)
...
overlap_intervals([0, 1, 10], [11, 5, 20], [6, 3], [7, 8])
